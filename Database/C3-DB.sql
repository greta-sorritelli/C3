...
--
-- Table structure for table `alert_clienti`
--

DROP TABLE IF EXISTS `alert_clienti`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `alert_clienti` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `IDCliente` int NOT NULL,
  `messaggio` varchar(500) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `IDClienteAlert_idx` (`IDCliente`),
  CONSTRAINT `IDClienteAlert` FOREIGN KEY (`IDCliente`) REFERENCES `clienti` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `alert_corrieri`
--

DROP TABLE IF EXISTS `alert_corrieri`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `alert_corrieri` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `IDCorriere` int NOT NULL,
  `messaggio` varchar(500) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `IDCorriereAlert_idx` (`IDCorriere`),
  CONSTRAINT `IDCorriereAlert` FOREIGN KEY (`IDCorriere`) REFERENCES `corrieri` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `alert_magazzinieri`
--

DROP TABLE IF EXISTS `alert_magazzinieri`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `alert_magazzinieri` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `IDPuntoPrelievo` int NOT NULL,
  `messaggio` varchar(500) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `IDPuntoPrelievoAlert_idx` (`IDPuntoPrelievo`),
  CONSTRAINT `IDPuntoPrelievoAlert` FOREIGN KEY (`IDPuntoPrelievo`) REFERENCES `punti_prelievo` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `clienti` (
  ...
  `codiceRitiro` char(12) DEFAULT NULL,
...
--
-- Table structure for table `codici_ritiro`
--

DROP TABLE IF EXISTS `codici_ritiro`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `codici_ritiro` (
  `codice` char(12) NOT NULL,
  `IDCliente` int NOT NULL,
  `IDOrdine` int NOT NULL,
  `dataCreazione` date NOT NULL,
  PRIMARY KEY (`codice`,`IDCliente`),
  KEY `IDCliente_idx` (`IDCliente`),
  KEY `IDOrdine_idx` (`IDOrdine`),
  CONSTRAINT `IDCliente` FOREIGN KEY (`IDCliente`) REFERENCES `clienti` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `IDOrdine` FOREIGN KEY (`IDOrdine`) REFERENCES `ordini` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `magazzinieri` (
  ...
  `cognome` varchar(45) NOT NULL,
  `password` varchar(12) DEFAULT NULL,
  PRIMARY KEY (`ID`,`IDPuntoPrelievo`),
  KEY `puntoPrelievo_idx` (`IDPuntoPrelievo`),
  CONSTRAINT `puntoPrelievo` FOREIGN KEY (`IDPuntoPrelievo`) REFERENCES `punti_prelievo` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `merci` (
  ...
  PRIMARY KEY (`ID`),
  KEY `IDOrdineMerce_idx` (`IDOrdine`),
  KEY `IDCorriereMerce_idx` (`IDCorriere`),
  CONSTRAINT `IDCorriereMerce` FOREIGN KEY (`IDCorriere`) REFERENCES `corrieri` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `IDOrdineMerce` FOREIGN KEY (`IDOrdine`) REFERENCES `ordini` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ordini` (
  ...
  `totalePrezzo` double DEFAULT NULL,
  `stato` varchar(45) NOT NULL,
  `IDPuntoPrelievo` int DEFAULT NULL,
  `residenza` varchar(45) DEFAULT '',
  `IDNegozio` int NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `IDClienteOrdine_idx` (`IDCliente`),
  KEY `IDNegozioOrdine_idx` (`IDNegozio`),
  CONSTRAINT `IDClienteOrdine` FOREIGN KEY (`IDCliente`) REFERENCES `clienti` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `IDNegozioOrdine` FOREIGN KEY (`IDNegozio`) REFERENCES `negozi` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `personale` (
  ...
  `password` varchar(12) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `IDNegozioCommesso_idx` (`IDNegozio`),
  CONSTRAINT `IDNegozioPersonale` FOREIGN KEY (`IDNegozio`) REFERENCES `negozi` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `promozioni` (
  `IDNegozio` int NOT NULL,
  `IDMerce` int NOT NULL,
  `messaggio` varchar(1000) NOT NULL,
  `prezzoAttuale` double NOT NULL,
  `prezzoPrecedente` double NOT NULL,
  PRIMARY KEY (`IDNegozio`,`IDMerce`),
  KEY `IDNegozioPromozioni_idx` (`IDNegozio`),
  KEY `IDMercePromozioni_idx` (`IDMerce`),
  CONSTRAINT `IDMercePromozioni` FOREIGN KEY (`IDMerce`) REFERENCES `inventario` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `IDNegozioPromozioni` FOREIGN KEY (`IDNegozio`) REFERENCES `negozi` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `punti_prelievo`
--

DROP TABLE IF EXISTS `punti_prelievo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `punti_prelievo` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(45) NOT NULL,
  `indirizzo` varchar(45) NOT NULL,
  PRIMARY KEY (`ID`)
...
-- Dump completed on 2021-02-22 16:12:44
